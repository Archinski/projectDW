# graduate-work-avito <sub><sup> [Archinski KandaAuer](https://github.com/Archinski/projectDW)
## Оглавление
...
### Канда- Backend Developer 
### Артур- Backend Developer
...
1. **Клонирование репозитория**:
  ...
  ```
  git clone https://github.com/Archinski/projectDW.git
  ```
